        ...
        with open('attributes.json') as json_file:
            ...
            try:
                for p in attribs['people']:
                    models.Person.objects.get_or_create(name=p)
            ...
            try:
                for p in attribs['animals']:
                    models.Animal.objects.get_or_create(name=p)
            ...
            try:
                for p in attribs['events']:
                    models.Event.objects.get_or_create(name=p)
            ...
            try:
                for p in attribs['classifiers']:
                    models.Classifier.objects.get_or_create(name=p)
